<script>
    ...
    let resultText = $_('page.home.welcome', {default: 'MISSING_TRANSLATION'})
    let name

    function greet() {
        Greet($_('page.home.greet', {default: 'Hello %s, it\'s show time!'}),name).then(result => resultText = result)
    }
</script>
